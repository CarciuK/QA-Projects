...
{
    [TestClass]
    public class PurchaseF
    {
        [TestMethod]
        public void TA_PurchaseF()
        {
            ...
            wait10.Until(ExpectedConditions.ElementIsVisible(By.XPath("//*[@id=\"delivery-address\"]/div/section/div[7]")));
